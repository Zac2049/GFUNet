...
#     # modified by lph
#     flops, params = profile(trainer, input_size=(1, 3, 224,224))
#     with open("../Output.txt", "w") as text_file:
#         print(f"FLOPs =  {str(flops/1000**3)} G", file=text_file)
#         print(f"Params =  {str(params/1000**2)} M", file=text_file)
    ...
    #print(list_of_lists)
    #print('*'*10)
    #print(cleaned_output_files)
    #exit()
    print("starting preprocessing generator")
    print("num_threads:",num_threads_preprocessing)
