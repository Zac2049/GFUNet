...
from nnunet.paths import default_plans_identifier, network_training_output_dir, default_cascade_trainer, default_trainer,preprocessing_output_dir
...
def main():
    ...
    if not os.path.exists(join(model_folder_name, "plans.pkl")):
        if args.model=='2d':
            plans_file = join(preprocessing_output_dir, task_name, args.plans_identifier + "_plans_2D.pkl")
        elif args.model=='3d_fullres':
